...
// Dados mockados para demonstração - versão executiva
const monthlyData = [
...
const metrics = {
  totalRevenue: 2450000, // Valor executivo maior
  monthlyRevenue: 185000, // Valor executivo maior
  ...
  return (
    <div className="w-full max-w-full space-y-4 md:space-y-6 p-4 md:p-6 custom-scroll overflow-x-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className={`text-xl md:text-2xl font-bold ${colors.text.title} flex items-center gap-2`}>
            <Crown className="h-6 w-6 text-yellow-500" />
            Dashboard Executivo
          </h1>
          <p className={`text-sm md:text-base ${colors.text.body}`}>
            Visão estratégica e métricas de alto nível para o proprietário, {user?.name}.
          </p>
        </div>
        ...
        <Card>
          <CardContent className="p-4 md:p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="h-10 w-10 md:h-12 md:w-12 rounded-lg bg-warning-100 dark:bg-warning-900 flex items-center justify-center">
                <Target className="h-5 w-5 md:h-6 md:w-6 text-warning-600 dark:text-white" />
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="dark:text-white">Ações Executivas</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            ...
            <Button variant="outline" className="h-16 sm:h-20 flex-col p-3 sm:p-4">
              <Target className="h-5 w-5 sm:h-6 sm:w-6 mb-1 sm:mb-2" />
